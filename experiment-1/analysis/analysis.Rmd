...
## All
```{r ioi-all, echo = FALSE, fig.width = 6, fig.height = 6}
...
### Remove outliers for dynamics (outside 2SD)
```{r, echo = FALSE}
...
### Remove outliers for articulation (outside 2SD)
```{r, echo = FALSE}
...
## All
```{r kot-all, echo = FALSE, fig.width = 7, fig.height = 4.5}
...
### Remove outliers for forte (outside 2SD)
```{r, echo = FALSE}
...
### Remove outliers for piano (outside 2SD)
```{r, echo = FALSE}
...
## All
```{r vel-all, echo = FALSE, fig.width = 7, fig.height = 4.5}
...
### Remove outliers for legato (outside 2SD)
```{r, echo = FALSE}
...
```{r vel-diff, include = FALSE, fig.width = 7, fig.height = 4.5}
...
## All
```{r vel-diff-all, echo = FALSE, fig.width = 7, fig.height = 4.5}
...
### Remove outliers for ltos (outside 2SD)
```{r, echo = FALSE}
