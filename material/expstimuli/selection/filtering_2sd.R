...
if (!file.exists("2sd/")){
  dir.create("2sd")
  dir.create("2sd/practice/")
}

if (!file.exists("2sd/art_teaching")){
  dir.create("2sd/art_teaching")
  dir.create("2sd/practice/art_teaching")
}

if (!file.exists("2sd/dyn_teaching")){
  dir.create("2sd/dyn_teaching")
  dir.create("2sd/practice/dyn_teaching")
}

if (!file.exists("2sd/art_performing")){
  dir.create("2sd/art_performing")
  dir.create("2sd/practice/art_performing")
}

if (!file.exists("2sd/dyn_performing")){
  dir.create("2sd/dyn_performing")
  dir.create("2sd/practice/dyn_performing")
}
...
for (i in 1:96){ # 24 stimuli for each category
  ...
  if (cond == "teaching" & skill == "articulation"){
    filename = paste("./2sd/art_teaching/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "teaching" & skill == "dynamics"){
    filename = paste("./2sd/dyn_teaching/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "performing" & skill == "articulation"){
    filename = paste("./2sd/art_performing/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "performing" & skill == "dynamics"){
    filename = paste("./2sd/dyn_performing/", subject, block, trial, ".txt", sep = "")
  }
...
for (i in 97:104){ # 4 stimuli for each category
  ...
  if (cond == "teaching" & skill == "articulation"){
    filename = paste("./2sd/practice/art_teaching/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "teaching" & skill == "dynamics"){
    filename = paste("./2sd/practice/dyn_teaching/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "performing" & skill == "articulation"){
    filename = paste("./2sd/practice/art_performing/", subject, block, trial, ".txt", sep = "")
  } else if (cond == "performing" & skill == "dynamics"){
    filename = paste("./2sd/practice/dyn_performing/", subject, block, trial, ".txt", sep = "")
  }
  fwrite(current, file = filename)
}
