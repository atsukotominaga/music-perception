...
In order to see which stimulus was recognised as teaching performances, we decided to run exploratory analysis. We plotted correlations between each DV and the percentage of judgement as "teaching".
