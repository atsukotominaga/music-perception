...
## Results
- 1. [Accuracy (private repo)](https://github.com/atsukotominaga/perception-v1.0/blob/master/analysis/analysis.Rmd)
...
In order to see which stimulus was recognised as teaching performances, we decided to run exploratory analysis. We plotted relationships between each DV and the percentage of judgement as "teaching" for each stimulus regardless of their original conditions (i.e., whether each stimulus was coming from the teaching or performing condition).
